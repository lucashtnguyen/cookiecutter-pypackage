...
def load_example_data():
    """
    Loads example data for {{ cookiecutter.project_slug }}.
    ...
    example : pandas.DataFrame
        The example data for {{ cookiecutter.project_slug }}

    Example
    -------
    >>> {{ cookiecutter.project_slug }}
    >>> data = {{ cookiecutter.project_slug }}.load_example_data()
    >>> print(data)
       A  B  C  D
    a  1  2  3  4
    b  5  6  7  8
    ...
    folder = '{{ cookiecutter.project_slug }}.tests.data'
...
def transpose_square(df):
    ...
    >>> {{ cookiecutter.project_slug }}.transpose_square(data)
        a   b   c
    A   1  25  81
    B   4  36   0
    C   9  49   1
...
def format_as_pct(value, decimal=2):
    ...
    --------
    >>> import {{ cookiecutter.project_slug }}
    >>> {{ cookiecutter.project_slug }}.format_as_pct(0.15678)
    '15.68%'
    >>> {{ cookiecutter.project_slug }}.format_as_pct(0.15678, decimal=1)
    '15.7%'
